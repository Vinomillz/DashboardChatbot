...
const DriverTable = ({ limit, title}: DriversTableProps) => {
    ...
    const sortedPosts: Driver[] = [...drivers].sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime())
  ...
  <Link href='/drivers'>  <button className="text-green-700 font-bold py-2 
